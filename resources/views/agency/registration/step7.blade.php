...
<form action="{{ route('agency.register.saveStep', $step) }}" method="POST" class="space-y-6">
    ...
    <div class="space-y-4">
        ...
        <div class="relative flex items-start">
            ...
            <div class="ml-3 text-sm">
                <label for="privacy_accepted" class="font-medium text-gray-700">I have read the <a href="{{ route('privacy') }}" class="text-indigo-600 hover:text-indigo-500" target="_blank">Privacy Policy</a>.</label>
            </div>
        </div>
