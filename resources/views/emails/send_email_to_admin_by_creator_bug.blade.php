                    ...
                    <tr>
                        <td style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif; padding: 35px;">
                            ...
                            <h1 style="margin-top: 0; color: #2F3133; font-size: 19px; font-weight: bold; text-align: left;">
                              {{trans('emails.hello')}} {{$admin_user->name}}
                            ...
                            <p style="margin-top: 0; color: #74787E; font-size: 16px; line-height: 1.5em;">This issue  send by <b>{{$fullname}}</b></p>
                            <a href="{{url('')}}" style="text-decoration: none;color:white;display:block;cursor: pointer;"><button style="width: fit-content;padding:10px 20px;outline:none;border:none;border-radius:2px;color:white;background-color:#c50279;margin-bottom:8px;font-family:sans-serif;cursor: pointer;">Check Now !</button></a>
