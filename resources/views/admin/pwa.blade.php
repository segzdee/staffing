                  ...
                  <!-- Start Box Body -->
                   <div class="box-body">
                     <div class="callout callout-info">
                       <p><i class="icon fa fa-info-circle myicon-right"></i> {{ __('general.alert_pwa_https') }}</p>
                     </div>
                   ...
                   <div class="box-body">
                     <div class="form-group">
                       <label class="col-sm-2 control-label">828x1792</label>
                       <div class="col-sm-10">
                       	<div class="btn btn-info box-file">
                       		<input type="file" accept="image/*" name="files[PWA_SPLASH_828]" class="filePhoto" />
                       		<i class="glyphicon glyphicon-cloud-upload myicon-right"></i>
                           <span class="text-file">{{ trans('general.choose_image') }}</span>
                       		</div>
                   ...
                   <div class="box-body">
                     <div class="form-group">
                       <label class="col-sm-2 control-label">1242x2688</label>
                       <div class="col-sm-10">
                       	<div class="btn btn-info box-file">
                       		<input type="file" accept="image/*" name="files[PWA_SPLASH_1242_2]" class="filePhoto" />
                       		<i class="glyphicon glyphicon-cloud-upload myicon-right"></i>
                           <span class="text-file">{{ trans('general.choose_image') }}</span>
                       		</div>
