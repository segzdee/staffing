<ul class="list-unstyled d-none d-lg-block menu-left-home sticky-top">
	...
	<li>
		<a  href="{{url('settings/verify/account')}}">
			...
			<span class="ml-2">{{ trans('general.become_creator') }}</span>
		</a>
	</li>
	...
	<li>
		<a  href="{{url('/my/report-list')}}" class="{{url()->current()==url('/my/report-list')?'active':''}}" data="{{url()->current()}}">
			<i class="bi bi-card-checklist"></i>
			<span class="ml-2">Ticket List</span>
		</a>
	</li>
