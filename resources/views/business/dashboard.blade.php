...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="lg:col-span-2">
        <x-dashboard.widget-card title="Upcoming Shifts" :action="route('business.shifts.index')" actionLabel="View all">
            <div class="space-y-4">
                ...
                <x-dashboard.shift-list-item
                    ...
                    :rate="$shift->final_rate ?? 0"
                    :filled="$shift->filled_workers"
                    :required="$shift->required_workers"
                    :href="route('business.shifts.show', $shift->id)"
                    action-label="View"
                />
                @empty
                <x-dashboard.empty-state
                    ...
                    description="Post a shift to start finding workers."
                    :action-url="route('shifts.create')"
                    action-label="Post a Shift"
                />
                @endforelse
            </div>
    ...
    <div class="space-y-6">
        ...
        <x-dashboard.quick-actions>
            ...
            <x-dashboard.quick-action
                href="{{ route('business.available-workers') }}"
...
<div class="mt-6">
    <x-dashboard.widget-card
        title="Shifts Needing Attention"
