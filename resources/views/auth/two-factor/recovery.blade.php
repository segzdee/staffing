...
<div class="auth-container">
    ...
    <div class="auth-card" x-data="recoveryForm()">
        ...
        <form method="POST" action="{{ route('two-factor.recovery.verify') }}" class="auth-form" @submit="handleSubmit">
            ...
            <div class="form-group">
                ...
                <input
                    ...
                    autofocus
                    autocomplete="off"
                    class="w-full text-center text-lg font-mono tracking-wider py-3 px-4 border rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-gray-900"
                    style="border-color: hsl(240 5.9% 90%);"
                    placeholder="XXXXXXXXXX"
                    :aria-invalid="errors.recovery_code ? 'true' : 'false'"
                >
        ...
        <a href="{{ route('two-factor.verify') }}" class="btn-form-secondary">
