    ...
    <div class="container container-lg-3 pt-5">
      <div class="row">
        ...
        <a href="{{ url('explore') }}" class="btn btn-primary btn-block mb-3 d-lg-none">
          <i class="far	fa-compass mr-1"></i> {{trans('general.explore_posts')}}
        </a>
          ...
          @if (auth()->user()->verified_id !== 'yes')
          <a type="button"  href="{{url('settings/verify/account')}}" class="btn btn-primary btn-block mb-2 d-lg-none" >
            <i class="far	 bi-star  mr-2"></i> {{trans('general.become_creator')}}
          </a>
          @endif
