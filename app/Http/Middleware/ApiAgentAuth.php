...
class ApiAgentAuth
{
     ...
     * Validates API key and attaches agent to request.
     *
    ...
    public function handle(Request $request, Closure $next)
    {
        ...
        cache()->increment($rateLimitKey . '_minute', 1);
        cache()->put($rateLimitKey . '_minute', $minuteRequests + 1, 60);
        cache()->increment($rateLimitKey . '_hour', 1);
        ...
        $request->merge(['agent_profile' => $agentProfile]);
