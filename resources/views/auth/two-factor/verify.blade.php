            ...
            <form method="POST" action="{{ route('two-factor.verify-code') }}" class="auth-form" @submit="handleSubmit">
                ...
                <div class="form-group">
                    ...
                    <div class="flex justify-center gap-2">
                        <x-ui.input type="text" id="code" name="code" x-model="code" @input="onCodeInput" maxlength="6"
                            pattern="[0-9]*" inputmode="numeric" autocomplete="one-time-code" required autofocus
                            class="w-full text-center text-2xl font-mono tracking-[0.5em] py-4 px-4 h-auto max-w-[220px]"
                            placeholder="000000" :aria-invalid="errors.code ? 'true' : 'false'" />
                    </div>
                ...
                <!-- Submit Button -->
                <x-ui.button type="submit" class="w-full" ::disabled="isSubmitting || code.length !== 6"
