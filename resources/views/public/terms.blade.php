...
@section('content')
    ...
    <section class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div class="bg-gray-50 rounded-lg p-6 mb-12">
            ...
            <nav class="space-y-2">
                <a href="#section-1" class="block text-sm text-gray-600 hover:text-blue-600 transition-colors">1. Acceptance of Terms</a>
                <a href="#section-2" class="block text-sm text-gray-600 hover:text-blue-600 transition-colors">2. Use of the Platform</a>
                <a href="#section-3" class="block text-sm text-gray-600 hover:text-blue-600 transition-colors">3. Worker Terms</a>
                <a href="#section-4" class="block text-sm text-gray-600 hover:text-blue-600 transition-colors">4. Business Terms</a>
                <a href="#section-5" class="block text-sm text-gray-600 hover:text-blue-600 transition-colors">5. Payment Terms</a>
                <a href="#section-6" class="block text-sm text-gray-600 hover:text-blue-600 transition-colors">6. Intellectual Property</a>
                <a href="#section-7" class="block text-sm text-gray-600 hover:text-blue-600 transition-colors">7. Privacy</a>
                <a href="#section-8" class="block text-sm text-gray-600 hover:text-blue-600 transition-colors">8. Disputes and Resolution</a>
                <a href="#section-9" class="block text-sm text-gray-600 hover:text-blue-600 transition-colors">9. Limitation of Liability</a>
                <a href="#section-10" class="block text-sm text-gray-600 hover:text-blue-600 transition-colors">10. Termination</a>
                <a href="#section-11" class="block text-sm text-gray-600 hover:text-blue-600 transition-colors">11. Changes to Terms</a>
                <a href="#section-12" class="block text-sm text-gray-600 hover:text-blue-600 transition-colors">12. Governing Law</a>
                <a href="#section-13" class="block text-sm text-gray-600 hover:text-blue-600 transition-colors">13. Contact Information</a>
            </nav>
        </div>
        ...
        <div class="mt-12 pt-8 border-t border-gray-200">
            ...
            <div class="grid md:grid-cols-3 gap-4">
                <a href="{{ route('privacy') }}" class="block p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
