    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h1 class="h3 mb-1">Create WhatsApp Template</h1>
                    <p class="text-muted mb-0">Create a new WhatsApp message template for approval by Meta</p>
                </div>
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.whatsapp.store') }}" method="POST" id="templateForm">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('template_id') is-invalid @enderror"
                                       id="template_id" name="template_id" value="{{ old('template_id') }}" required
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('language') is-invalid @enderror"
                                    ...
                                    <option value="zh_CN" {{ old('language') == 'zh_CN' ? 'selected' : '' }}>Chinese (Simplified)</option>
                                </select>
                                @error('language')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="form-text">
                                    <strong>Utility:</strong> Transactional updates (shift reminders, confirmations)<br>
                                    <strong>Marketing:</strong> Promotional messages<br>
                                    <strong>Authentication:</strong> OTP/verification codes
                                </div>
                                @error('category')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 mb-3" id="headerContentGroup" style="display: none;">
                                ...
                                <input type="text" class="form-control @error('header_content') is-invalid @enderror"
                                       id="header_content" name="header_content" value="{{ old('header_content') }}"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('content') is-invalid @enderror"
                                      ...
                                      placeholder="Enter your message template with {{1}}, {{2}}, etc. for variables">{{ old('content') }}</textarea>
                            <div class="form-text">
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <a href="{{ route('admin.whatsapp.index') }}" class="btn btn-outline-secondary">Cancel</a>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Initialize
    if (headerType.value) {
        headerType.dispatchEvent(new Event('change'));
    }
});
</script>
@endpush
