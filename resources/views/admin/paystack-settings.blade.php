...
<!-- Content Wrapper. Contains page content -->
    ...
    @if ( ! in_array($settings->currency_code, ['NGN', 'GHS', 'ZAR', 'USD']) && $data->enabled == 1)
      <div class="alert alert-danger">
          {{  $settings->currency_code .' ' . trans('general.error_currency') }}
      </div>
    @endif
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  @endif
                  <input type="password" name="key_secret" class="form-control" placeholder="Enter new secret key to update" autocomplete="new-password">
                 <p class="help-block"><a href="https://dashboard.paystack.com/#/settings/developer" target="_blank" rel="noopener noreferrer">https://dashboard.paystack.com/#/settings/developer</a></p>
                </div>
              </div>
            </div><!-- /.box-body -->
