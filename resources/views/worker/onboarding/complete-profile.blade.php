...
@section('page-subtitle', 'Just a few more steps to start finding shifts')
...
<div class="max-w-4xl mx-auto">
        ...
        <div class="flex">
            ...
            <div class="ml-3">
                ...
                <p class="mt-1 text-sm text-gray-700">
                    A complete profile increases your chances of getting hired by up to 80%.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg border border-gray-200 p-6">
        <div class="flex flex-col sm:flex-row gap-4">
            <a href="{{ route('worker.profile') }}" class="flex-1 inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-lg text-white bg-gray-900 hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors">
                <svg class="mr-2 h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                </svg>
                Complete Profile Now
            </a>
            <a href="{{ route('worker.dashboard') }}" class="flex-1 inline-flex items-center justify-center px-6 py-3 border border-gray-300 text-base font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors">
                Skip for Now
            </a>
        </div>
    ...
    <div class="mt-8 bg-gray-50 rounded-lg border border-gray-200 p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="flex items-start">
                ...
                <p class="ml-3 text-sm text-gray-700">Get matched with relevant shifts automatically</p>
            </div>
            <div class="flex items-start">
                <div class="flex-shrink-0">
                    <svg class="h-6 w-6 text-gray-900" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <p class="ml-3 text-sm text-gray-700">Receive direct invitations from employers</p>
            </div>
            <div class="flex items-start">
                <div class="flex-shrink-0">
                    <svg class="h-6 w-6 text-gray-900" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <p class="ml-3 text-sm text-gray-700">Stand out from other applicants</p>
            </div>
        </div>
    </div>
</div>
