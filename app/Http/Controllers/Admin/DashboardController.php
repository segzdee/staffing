    ...
    public function index()
    {
        ...
        try {
            ...
            return view('admin.dashboard', [
                ...
                'metrics' => [
                    ['label' => 'Total Users', 'value' => 0, 'subtitle' => 'All user types', 'icon' => 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z'],
                    ['label' => 'Open Shifts', 'value' => 0, 'subtitle' => 'Currently available', 'icon' => 'M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z'],
                    ['label' => 'Revenue Today', 'value' => '$0.00', 'subtitle' => 'Platform fees', 'icon' => 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z'],
                    ['label' => 'Pending', 'value' => 0, 'subtitle' => 'Verifications', 'icon' => 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z'],
                ],
                'onboardingProgress' => 100,
                'unreadNotifications' => 0,
                'unreadMessages' => 0,
