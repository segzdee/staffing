...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-8 flex items-center justify-between">
        ...
        <div class="flex gap-2">
            <a href="{{ route('worker.paystubs.preview', $payrollRun) }}" target="_blank" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md text-sm font-medium text-gray-700 bg-white hover:bg-gray-50" rel="noopener noreferrer">
