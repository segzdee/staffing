...
<div x-data="{
    ...
    }" class="w-full max-w-md glass-effect rounded-2xl shadow-2xl p-8 transition-all duration-300" role="region"
    aria-label="Authentication form">
    <!-- Tab Switcher -->
    <div class="flex space-x-2 mb-6 bg-gray-100 p-1 rounded-lg" role="tablist">
        <button @click="switchMode('signin')"
            ...
            role="tab" :aria-selected="mode === 'signin'" aria-controls="signin-panel">
            Sign In
        </button>
        <button @click="switchMode('register')"
            :class="mode === 'register' ? 'bg-white shadow-sm text-brand-orange' : 'text-gray-600'"
            class="flex-1 py-2 px-4 rounded-md font-semibold transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-brand-orange"
            role="tab" :aria-selected="mode === 'register'" aria-controls="register-panel">
            Register
        </button>
    </div>

    <!-- Sign In Panel -->
    <div x-show="mode === 'signin'" x-transition:enter="transition ease-out duration-300"
        x-transition:enter-start="opacity-0 transform scale-95" x-transition:enter-end="opacity-100 transform scale-100"
        id="signin-panel" role="tabpanel">
        ...
        <form action="{{ route('login') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" id="signin-email" name="username_email"
            ...
            <div>
                ...
                <div class="relative">
                    <input :type="showPassword ? 'text' : 'password'" id="signin-password" name="password"
            ...
            <div class="flex items-center justify-between text-sm">
                ...
                <a href="{{ route('password.request') }}"
                    class="text-brand-orange hover:text-brand-coral transition-colors">
                    Forgot password?
                </a>
            </div>
        ...
        <div class="mt-6 text-center">
            <p class="text-sm text-gray-600">
                ...
                <button @click="switchMode('register')"
                    class="text-brand-orange font-semibold hover:text-brand-coral transition-colors">
                    Register now
                </button>
            </p>
        </div>
    ...
    <div x-show="mode === 'register'" x-transition:enter="transition ease-out duration-300"
        ...
        <div class="mb-6">
            ...
            <div class="grid grid-cols-3 gap-2">
                <button @click="selectAccountType('worker')"
                    ...
                    type="button" role="radio" :aria-checked="accountType === 'worker'">
                ...
                <button @click="selectAccountType('business')"
                    ...
                    type="button" role="radio" :aria-checked="accountType === 'business'">
                    <svg class="w-6 h-6 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <button @click="selectAccountType('agency')"
                    ...
                    type="button" role="radio" :aria-checked="accountType === 'agency'">
                    <svg class="w-6 h-6 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <form action="{{ route('register') }}" method="POST" class="space-y-4">
            ...
            <div class="grid grid-cols-2 gap-3">
                <div>
                    ...
                    <input type="text" id="register-firstname" name="first_name"
                ...
                <div>
                    ...
                    <input type="text" id="register-lastname" name="last_name"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-orange focus:border-transparent transition-all"
                        required>
                </div>
            </div>
            ...
            <button type="submit"
                ...
                <span
                    x-text="accountType === 'worker' ? 'Start Finding Shifts' : accountType === 'business' ? 'Post Your First Shift' : 'Register Agency'"></span>
            </button>
        </form>
