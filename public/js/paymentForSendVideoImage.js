...
// 	$('input[name=payment_gateway_pay_for_video_or_image]').on('click', function() {
//     if($(this).val() == 2) {
//       $('#stripeContainerPayForVideoOrImage').slideDown();
//     } else {
//       $('#stripeContainerPayForVideoOrImage').slideUp();
//     }
//   });
...
//  cardElement.mount('#card-elementPayForVideoImage');

//  // Handle real-time validation errors from the card Element.
//  cardElement.addEventListener('change', function(event) {
// 	 var displayError = document.getElementById('card-errors-payment_gateway_pay_for_video_or_image');
// 	 var payment = $('input[name=payment_gateway_pay_for_video_or_image]:checked').val();
...
//  var cardholderName = document.getElementById('cardholder-name-oay');
//  var cardholderEmail = document.getElementById('cardholder-email-pay');
...
// 					 }
// 			 }
// 			 $('#payForSendVideoImageBtn').removeAttr('disabled');
// 			 $('#payForSendVideoImageBtn').find('i').removeClass('spinner-border spinner-border-sm align-middle mr-1');

// 		 } else {

// 			 $('#payForSendVideoImageBtn').attr({'disabled' : 'true'});
// 			 $('#payForSendVideoImageBtn').find('i').addClass('spinner-border spinner-border-sm align-middle mr-1');
...
// 			 $('#formSendPayVideoOrImage').append($input);
...
// 				type: "POST",
// 				dataType: 'json',
// 				url: URL_BASE+"/send/pay-for-vide-image",
// 				data: $('#formSendPayVideoOrImage').serialize(),
...
//                 swal({
//                         type: 'error',
//                         title: "Oops! something is wrong try again",
...
// 					type: "POST",
// 					dataType: 'json',
// 					url: URL_BASE+"/send/pay-for-send-video-image",
...
// 									$('#formSendPayVideoOrImage').modal('hide');
// 				 	 				$('.InputElement').val('');
// 				 	 				$('#formSendPayVideoOrImage').trigger("reset");
// 				 	 				$('#payForSendVideoImageBtn').removeAttr('disabled');
// 				 	 				$('#payForSendVideoImageBtn').find('i').removeClass('spinner-border spinner-border-sm align-middle mr-1');
...
// //<---------------- Pay for send video and image all ----------->>
//  $(document).on('click','#button-reply-msg',function(s) {
// //pay for video or image

// // $("#payForSendImageOrVideo-modal").modal("show");
// return false;


 
//  //end pay for video or image
// 	 s.preventDefault();
// 	 var element = $(this);
...
// 	 })(); //<--- FUNCTION %
//  });//<<<-------- * END FUNCTION CLICK * ---->>>>
// //============ End payment for send image or video  =================//
