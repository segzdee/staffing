           ...
           <div class="box-body">
             <div class="form-group">
               ...
               <div class="col-sm-10">
                 ...
                 @endif
                 <input type="password" name="key_secret" class="form-control" placeholder="Enter new access token to update" autocomplete="new-password">
                <p class="help-block"><a href="https://www.mercadopago.com/mlb/account/credentials" target="_blank" rel="noopener noreferrer">https://www.mercadopago.com/mlb/account/credentials</a></p>
               </div>
             </div>
           </div><!-- /.box-body -->
