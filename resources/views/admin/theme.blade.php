                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        <div class="btn-block margin-bottom-10">
                          <img src="{{url('/img', $settings->logo)}}" class="logo-theme">
                        </div>
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        <div class="btn-block margin-bottom-10">
                          <img src="{{url('/img', $settings->logo_2)}}" class="w-150">
                        </div>
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        <div class="btn-block margin-bottom-10">
                          <img src="{{url('/img', $settings->home_index)}}" class="w-200">
                        </div>
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        <div class="btn-block margin-bottom-10">
                          <img src="{{url('/img', $settings->bg_gradient)}}" class="w-400">
                        </div>
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        <div class="btn-block margin-bottom-10">
                          <img src="{{url('/img', $settings->img_1)}}" class="w-120">
                        </div>
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        <div class="btn-block margin-bottom-10">
                          <img src="{{url('/img', $settings->img_2)}}" class="w-120">
                        </div>
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        <div class="btn-block margin-bottom-10">
                          <img src="{{url('/img', $settings->img_3)}}" class="w-120">
                        </div>
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        <div class="btn-block margin-bottom-10">
                          <img src="{{url('/img', $settings->img_4)}}" class="w-120">
                        </div>
