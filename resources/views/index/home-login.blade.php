      ...
      <div class="row">
        ...
        <div class="col-lg-5">
          ...
          <div class="card bg-white shadow border-0">
            ...
            <div class="card-body px-lg-5 py-lg-5 pt-4">
              ...
              <small class="btn-block text-center pb-4 h6 cklogin">{{ trans('general.title_home_login') }}</small>
        ...
        @if (session('login_required'))
              ...
              <form method="POST" action="{{ route('login') }}" data-url-login="{{ route('login') }}" data-url-register="{{ route('register') }}" id="formLoginRegister" enctype="multipart/form-data">
                ...
                <small class="form-text ckforgot text-muted">
            ...
            <hr>
              ...
              <div class="row mt-3">
                <div class="col-12 text-center">
                  <a href="javascript:void(0);" id="toggleLogin" data-not-account="{{trans('auth.not_have_account')}}" class="btn btn-primary mt-4 "  data-already-account="{{trans('auth.already_have_an_account')}}" data-text-login="{{trans('auth.login')}}" data-text-register="{{trans('auth.sign_up')}}">
                    <strong>{{trans('general.Create_account')}}</strong>
                  </a>
                </div>
              </div>
            @endif
