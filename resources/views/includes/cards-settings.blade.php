...
<a href="{{url('settings/restrictions')}}" class="list-group-item list-group-item-action d-flex justify-content-between @if (request()->is('settings/restrictions')) active @endif">
	...
	<div class="card shadow-sm card-settings">
			<div class="list-group list-group-sm list-group-flush">
				...
				<small class="text-muted px-4 pt-3 text-uppercase mb-1 font-weight-bold">{{ trans('general.setting') }}</small>

				<a href="{{url('settings/video-setting')}}" class="list-group-item list-group-item-action d-flex justify-content-between ">
					<div>
						<i class="bi bi-camera-video mr-2"></i>
							<span>{{trans("general.video_setting")}}</span>
					</div>
					<div>
							<i class="feather icon-chevron-right"></i>
					</div>
			</a>
			<a href="{{url('settings/photo-setting')}}" class="list-group-item list-group-item-action d-flex justify-content-between ">
				<div>
					<i class="bi bi-images mr-2"></i>
						<span>{{trans("general.image_setting")}}</span>
				</div>
				<div>
						<i class="feather icon-chevron-right"></i>
				</div>
		</a>
		{{-- <a href="{{url('settings/message-setting')}}" class="list-group-item list-group-item-action d-flex justify-content-between ">
			<div>
				<i class="bi bi-chat mr-2"></i>
					<span>{{trans("general.message_setting")}}</span>
			</div>
			<div>
					<i class="feather icon-chevron-right"></i>
			</div>
